...
const SUPABASE_KEY="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdhemNldmJveXFmaXhobHZyZ256Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzIwMjc1MDQsImV4cCI6MjA0NzYwMzUwNH0.-_sGao6yKoJT6-Gr1VyWatlBed0rQrG7r9wTg-m2x_k"
...
export async function getOrderData(): Promise<Map<string, number[]>> {
    ...
    const data = response.data as {userName: string, itemId: number, count: number}[]
